...
check('attendance code rotates weekly', '_office_code_week' in attendance and 'qr_valid_week' in attendance and 'Changes weekly' in franchise_staff_page)
...
check('office attendance code visible and printable', 'Four-digit code' in franchise_staff_page and 'OFFICE CODE:' in attendance)
...
check('attendance QR scan advances to photo', 'await prepareEvidence()' in mobile and 'Step 3' in mobile and 'SignaturePad' in mobile)
check('attendance QR scanner extracts URL code', 'officeCodeFromScan' in mobile and "searchParams.get('office_qr')" in mobile)
check('attendance manual code is fallback only', 'Cannot scan? Enter office code' in mobile and 'manualCodeEntry' in mobile)
