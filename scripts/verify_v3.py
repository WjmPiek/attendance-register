...
check('attendance phase 3 migration head', '010_attendance_mobile_integrity' in attendance_migration)
check('attendance QR optional', "and payload.qr_value" in attendance and '(optional)' in mobile)
