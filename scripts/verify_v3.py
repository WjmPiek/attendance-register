...
check('attendance outside office radius rejected', "gps_status = 'outside_area'" in attendance and 'outside the allowed range of your assigned office' in attendance)
