...
export default function BusinessInformationPage({ me }) {
  ...
  return (
    <div className="business-information-page">
      <section className="form-card business-info-hero">
        <div><p className="eyebrow">Franchise profile</p><h1>Business Information</h1><p className="muted">Manage the business profile, Head Office GPS and the single active attendance QR code. Available to franchise and master users. Master users can manage registered franchise business locations from the master account.</p></div>
